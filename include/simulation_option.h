...
#define SOR_SMOOTH_STEP         100                           // Smooth step converge lower than 10000 for N=200
#define SOR_EXACT_STEP          100                          // Exact step will only affect on SOR solver. 
#define SOR_ERROR               1.e-6                          // Solver converge threshold
