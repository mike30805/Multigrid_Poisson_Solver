...
#define BOX_L                   6.                             // Simulation box size.
...
#define SOR_SMOOTH_STEP         500                           // Smooth step converge lower than 10000 for N=200
#define SOR_EXACT_STEP          1000                          // Exact step will only affect on SOR solver. 
#define SOR_ERROR               1.e-15                          // Solver converge threshold
